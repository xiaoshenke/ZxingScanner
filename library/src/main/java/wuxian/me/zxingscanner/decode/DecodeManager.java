...
import wuxian.me.zxingscanner.camera.QRCodeCamera;
import wuxian.me.zxingscanner.preview.PreviewData;
...
public final class DecodeManager {
    ...
    public static String getQrcodeFromPreviewData(Context context, PreviewData input) throws DecodeException {
        ...
        PlanarYUVLuminanceSource source = getSourceFromPreviewData(context, new PreviewData(new Point(width, height), data));
